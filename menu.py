...
def play():
    ...
    while True:
        ...
        play_back = Button(image=None, pos=(640, 450), text_input="BACK", font=get_font(75), base_color="White", hover_color="Red")
...
def settings():
    ...
    while True:
        ...
        settings_back = Button(image=None, pos=(640, 450), text_input="BACK", font=get_font(75), base_color="White", hover_color="Red")
